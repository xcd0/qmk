...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * | GUI  | ESC  |   1  |   2  |   3  |   4  |   5  |  <   |  |   >  |   6  |   7  |   8  |   9  |   0   |  -    | Delete|
   * |------+------+------+------+------+------+------+------|  |------+------+------+------+------+-------+-------+-------|
   * | Alt  | Tab  |   Q  |   W  |   D  |   F  |   G  |  (   |  |   )  |   Y  |   S  |   T  |   R  |   P   |  @    | BkSp  |
   * |------+------+------+------+------+------+------+------|  |------+------+------+------+------+-------+-------+-------|
  ...
  [_SYMBOL] = LAYOUT( \
      JP_LGUI, JP_ESC,  JP_1,    JP_2,    JP_3,    JP_4,    JP_5,    _______, /**/ _______, JP_6,    JP_7,    JP_8,    JP_9,    JP_0,    _______, _______, \
      JP_LALT, JP_TAB,  JP_TILD, JP_UNDS, JP_DQT,  JP_QUOT, JP_GRV,  _______, /**/ _______, JP_AMPR, JP_LPRN, JP_LT,   JP_LCBR, JP_LBRC, JP_BSPC, _______, \
      JP_INS,  JP_LCTL, JP_PLUS, JP_MINS, JP_ASTR, JP_EQL,  JP_COLN, _______, /**/ _______, JP_PIPE, JP_RPRN, JP_GT,   JP_RCBR, JP_RBRC, JP_ENT,  _______, \
